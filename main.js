(function () {
  ...
  // A page can opt out of the global music bar with <body data-no-miniplayer>
  // — the arcade does, so the emulator's audio isn't competing with it.
  if (YT_PLAYLIST_ID && !document.body.hasAttribute('data-no-miniplayer') && !document.getElementById('miniplayer')) {
