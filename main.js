(function () {
  ...
  // The music bar is opt-in: only pages carrying <body data-miniplayer> get it.
  // Everywhere else stays quiet (and skips loading the YouTube IFrame API).
  if (YT_PLAYLIST_ID && document.body.hasAttribute('data-miniplayer') && !document.getElementById('miniplayer')) {
